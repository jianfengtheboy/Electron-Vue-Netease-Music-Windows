 ...
 * @LastEditTime: 2020-06-05 00:02:31
 * @Description: 动态
 -->
<template>
  <div>
      ...
      <template v-for="(event, index) in events">
        ...
        >
          <div class="event-user-box">
            ...
            <div class="action">
              <a-button type="link" size="small" icon="check" @click="subscribe(2, event.user)"
                        v-if="event.user.followed">已关注
              </a-button>
          ...
          <div class="event-detail">
            ...
            <div
              class="event-info"
              :class="{'video':Object.keys(event.json)[1]==='video','song':Object.keys(event.json)[1]==='song', 'zoom':event.currentIndex>=0 && event.currentIndex === currentIndex}"
            >
              <component
                ref="component"
            ...
            <div class="event-exrea">
              <div class="rcmdInfo" v-if="event.rcmdInfo">—— {{ event.rcmdInfo.reason }}</div>
              <div class="actions">
                <ul>
                  <li>
...
export default {
  ...
  methods: {
    ...
    onEventClick (event, index) {
      ...
      if ( this.currentIndex >= 0 && Object.keys(this.events[ this.currentIndex ].json)[ 1 ] === 'video' ) {
        this.$refs.component[ this.currentIndex ].pause && this.$refs.component[ this.currentIndex ].pause()
      }
